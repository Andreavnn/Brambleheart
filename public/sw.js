const CACHE='brambleheart-shell-v0.10'
const SHELL=['/','/news','/assets/Logo.png','/icons/favicon-64.png?v=0.10','/icons/icon-192.png?v=0.10','/icons/icon-512.png?v=0.10','/icons/icon-maskable-512.png?v=0.10','/icons/apple-touch-icon.png?v=0.10','/manifest.webmanifest?v=0.10','/audio/brambleheart-launch.wav']
