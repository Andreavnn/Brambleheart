...
- Added the approved Brambleheart logo and app icon supplied for v0.01.
- Vercel is configured to build and serve the static `dist/` output while preserving SPA deep links.
