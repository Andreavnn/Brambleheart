...
import { ADVENTURE_KIT_ITEMS, adventureKitEquipment } from '../data/equipmentNormalization'
...
const derived=computed(()=>derivedStats(effectiveAttributes.value,0,0,gearSpeedPenalty.value))
const reviewGuts=computed(()=>derivedStats(effectiveAttributes.value,gearGutsBonus.value,gearControlBonus.value,gearSpeedPenalty.value).guts)
const reviewControl=computed(()=>derivedStats(effectiveAttributes.value,gearGutsBonus.value,gearControlBonus.value,gearSpeedPenalty.value).control)
...
.review-spell-column{display:grid!important;grid-template-columns:1fr!important;gap:10px!important}
