...
.news-promo-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin:10px 0 14px}.news-promo-card{display:grid;grid-template-rows:auto minmax(112px,1fr) auto;align-items:start;gap:8px;width:100%;min-width:0;min-height:210px;padding:12px 14px;border:1px solid var(--line-dark);background:var(--paper);color:var(--ink);text-align:center;text-decoration:none;cursor:pointer}.news-promo-card>strong{display:block;font-family:Georgia,'Times New Roman',serif;font-size:calc(20px + var(--font-offset));line-height:1.1}.news-promo-visual{display:flex;flex-direction:column;align-items:center;justify-content:center;min-width:0;min-height:112px}.news-promo-visual img{display:block;width:auto;max-width:100%;object-fit:contain}.news-promo-visual .discord-community-image,.news-promo-visual .share-brambleheart-image{height:132px}.news-promo-visual .creator-content-image{height:144px}.news-promo-card>small{color:var(--ink-soft);line-height:1.35}.news-promo-count{display:block;min-height:1.35em;margin-top:2px;color:var(--ink-soft);font-weight:800;line-height:1.2}.news-promo-card:hover,.news-promo-card:focus-visible{border-color:var(--ui-active);background:var(--paper-2)}@media(max-width:720px){.news-promo-grid{grid-template-columns:1fr}.news-promo-card{min-height:180px}.news-promo-visual{min-height:96px}.news-promo-visual .discord-community-image,.news-promo-visual .share-brambleheart-image{height:110px}.news-promo-visual .creator-content-image{height:122px}}
</style>
