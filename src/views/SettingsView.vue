...
const customDataLabel=ref(localStorage.getItem('brambleheart-custom-data-name-v0.06')||localStorage.getItem('brambleheart-custom-data-name-v0.05')||'None loaded')
...
function clearAllLocalData(){
  ...
  const keys=['brambleheart-characters-v0.01','brambleheart-rules-recent-v0.03','brambleheart-rules-recent-v0.04','brambleheart-rules-recent-v0.05','brambleheart-rules-recent-v0.06','brambleheart-simulator-encounters-v0.05','brambleheart-simulator-rhythm-v0.05','brambleheart-custom-data-v0.05','brambleheart-custom-data-name-v0.05','brambleheart-custom-data-v0.06','brambleheart-custom-data-name-v0.06','brambleheart.welcome.v0.04','brambleheart.welcome.v0.05','brambleheart.welcome.v0.06','brambleheart.install-welcome-dismissed.v0.04','brambleheart.install-welcome-dismissed.v0.05','brambleheart.install-welcome-dismissed.v0.06']
...
async function importCustomData(event:Event){
  ...
  try{const raw=await file.text();JSON.parse(raw);localStorage.setItem('brambleheart-custom-data-v0.06',raw);localStorage.setItem('brambleheart-custom-data-name-v0.06',file.name);customDataLabel.value=file.name}
  catch{alert('Custom Data must be a valid JSON file.')}
  input.value=''
}
function clearCustomData(){if(!confirm('Remove the locally loaded Custom Data file?'))return;localStorage.removeItem('brambleheart-custom-data-v0.06');localStorage.removeItem('brambleheart-custom-data-name-v0.06');localStorage.removeItem('brambleheart-custom-data-v0.05');localStorage.removeItem('brambleheart-custom-data-name-v0.05');customDataLabel.value='None loaded'}
</script>
...
<template>
  <main class="page settings-page">
    ...
    <section class="settings-group" aria-label="Donation"><div class="settings-group-heading"><p class="eyebrow settings-group-title">DONATION</p></div><section class="settings-card support-settings-card"><div class="setting-row static-row support-copy-row"><span><strong>Support Brambleheart</strong><small>Voluntary support helps cover development, hosting, and the services used to keep Brambleheart available.</small></span></div><div class="support-button-row"><a class="secondary-button support-action-button" href="https://donate.stripe.com/eVq28r5fM5PI1bKdzz3Nm04" target="_blank" rel="noopener noreferrer">Donation</a><a class="secondary-button support-action-button" href="https://donate.stripe.com/cNifZh4bIce6bQo5333Nm05" target="_blank" rel="noopener noreferrer">Recurring Support</a></div></section></section>
