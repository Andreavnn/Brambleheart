...
import { armorProfile, derivedStats, equippedProtectiveGear, equipmentControlBonus, equipmentGutsBonus, magicResources, normalizeSkillName, rankModifier, rhythmResult, structuredRule, visibleRuleFields, weaponProfile } from '../rules/rulesEngine'
...
const resources=computed(()=>selectedCharacter.value?magicResources(selectedCharacter.value.attributes,magicLevel.value):{manaPool:0,magicRegen:0})
