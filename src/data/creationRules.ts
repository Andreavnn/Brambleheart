...
export const cultureSkillGrants: Record<string, CultureSkillGrant> = {
  ...
  'Cethra::Artisan’s Focus': { fixed:['Tumblecraft'], choices:[['Shadehand','Whisperstep']] },
  'Hedgkin::Thicket Craft': { fixed:['Seeking','Herbalry'], choices:[['Lorekeeping','Wayfinding','Tradeskill']] },
  'Ravari::Jester Of Trade': { fixed:['Guile','Tumblecraft'], choices:[['Shadehand','Stonegrasp','Whisperstep','Seeking','Wayfinding']] },
