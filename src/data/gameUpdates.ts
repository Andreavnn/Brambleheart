...
export const gameUpdates:GameUpdateEntry[]=[
  {
    ...
    changes:[
      ...
      'Standard, Direct, and Lethal remain the Damage Categories. Health states use Wounded at [7] or less, Critical at [4] or less, Last Breath at [2] or less, and Defeated at [0]; Fate Rolls pass on [5–10] and add a Fate Mark on [1–4].',
      ...
      'Trinkets are passive equipped gear. Driftwood Charm increases one healing Spell’s Health restoration by [+1] for one target once per round. Scriptweave Book grants [+1] Magic Regen, binds its [-1] Mana reduction to one known Lore Spell, and gives that Spell a cooldown.',
