...
export const gameUpdates:GameUpdateEntry[]=[
  ...
  },
  {
    ...
    summary:'Consolidates the current equipment/trinket model, normalized protective gear rules, and the approved Axalori Trait revisions into one rules update.',
    changes:[
      ...
      'Ordinary weapon, armor, and shield profiles/prices are normalized, and equipped armor/shield Guts, Mana Syphon, and Armor Penalty feed the shared derived-stat calculations.',
  ...
  },
  {
    ...
    changes:[
      ...
      'The selected path and its Skill/Attribute choices are persisted as canonical character data for saved, imported, reviewed, and advanced characters.',
    ],
  },
  {
    version:'0.02',
