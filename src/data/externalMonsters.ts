...
const glopProfile:MonsterProfile={
  ...
  actions:[
    ...
    {name:'Gelatinous Bash',type:'Touch',text:'TRIGGER: During the Creature’s Turn. TARGET: One character within Touch. TO HIT: Make a Melee Strike using the Creature’s Brawl. DAMAGE: [3] + Fury Standard damage.',keywords:['CORE']},
    ...
    {name:'Reconstitute',type:'Instinct',text:'TRIGGER: At the start of the round, if the Creature is below half Health. EFFECT: The Creature rolls [1d10]. On [6+], restore [1] Health to the Creature.\nCOOLDOWN: This Ability cannot be used again for [1d10/2] rounds.',keywords:['INSTINCT']},
  ],
  monstrousTraits:[
    {name:'Slick Trail',text:'TRIGGER: When the Creature moves. EFFECT: Every square the Creature moves through becomes Slick until the end of the round. Other characters must spend [+1] additional Speed to enter each Slick square.',keywords:['PASSIVE','MOVEMENT']},
    {name:'Gelatinous Body',text:'TRIGGER: When the Creature suffers Direct damage. EFFECT: Reduce that Direct damage by [-1], to a minimum of [0] damage after all other applicable reductions.',keywords:['PASSIVE']},
