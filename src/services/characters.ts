...
export interface PurchasedEquipment { name:string; costSp:number; category?:string; detail?:string; effect?:string; choice?:string }
...
export function characterExportPayload(character:CharacterRecord){return{format:'brambleheart-character',version:'0.09',character}}
