...
const STRUCTURED_RULE_LABELS=['COST','TRIGGER','DECLARE','DECLEAR','TARGET','AREA','STRIKE','TO HIT','ATTRIBUTE SAVE','SAVE','HEX','ON FAILURE','EFFECT','SECOND CAST','DAMAGE','LONG RANGE','PICK UP','AFTERBURN','PURIFY','EMPOWER','IMPACT','DURATION','OPEN DEFENCE','ARMOR MASTERY','DEFENSELESS','FORTIFIED','RAPID ATTACK','RESTICTION','RESTICTIONS','RESTRICTION','RESTRICTIONS','REQUIRES','COOLDOWN','KEYWORDS'] as const
const RULE_FIELD_ORDER=['COST','TRIGGER','DECLARE','TARGET','AREA','TO HIT','SAVE','HEX','ON FAILURE','EFFECT','SECOND CAST','DAMAGE','IMPACT','LONG RANGE','PICK UP','AFTERBURN','PURIFY','EMPOWER','DURATION','OPEN DEFENCE','ARMOR MASTERY','DEFENSELESS','FORTIFIED','RAPID ATTACK','RESTRICTIONS','REQUIRES','COOLDOWN','KEYWORDS'] as const
