...
const RULE_FIELD_ORDER=['COST','TRIGGER','DECLARE','TARGET','AREA','TO HIT','SAVE','HEX','ON FAILURE','ON SUCCESS','EFFECT','FORMLESS','SECOND CAST','DAMAGE','IMPACT','LONG RANGE','PICK UP','AFTERBURN','PURIFY','EMPOWER','DURATION','OPEN DEFENCE','ARMOR MASTERY','DEFENSELESS','FORTIFIED','RAPID ATTACK','COOLDOWN','RESTRICTIONS','REQUIRES','EXAMPLE','KEYWORDS'] as const
