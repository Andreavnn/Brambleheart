...
const STRUCTURED_RULE_LABELS=['COST','TRIGGER','DECLARE','DECLEAR','TARGET','AREA','STRIKE','TO HIT','ATTRIBUTE SAVE','SAVE','HEX','ON FAILURE','ON SUCCESS','EFFECT','SLOSH','ELEMENTAL SLOSH','SEEPING SLOSH','PRISMATIC SURGE','CINDERSTEP','ICEFALL','THUNDERSTEP','ROOTWALK','WYRDFOLD','CINDER','CHILL','ARC','STATIC','OVERGROWTH','RENEWAL','DISRUPTION','FORMLESS','SECOND CAST','DAMAGE','TOXIN','LONG RANGE','PICK UP','AFTERBURN','PURIFY','EMPOWER','IMPACT','DURATION','OPEN DEFENCE','ARMOR MASTERY','DEFENSELESS','FORTIFIED','RAPID ATTACK','RESTICTION','RESTICTIONS','RESTRICTION','RESTRICTIONS','REQUIRES','COOLDOWN','EXAMPLE','KEYWORDS'] as const
const RULE_FIELD_ORDER=['COST','TRIGGER','DECLARE','TARGET','AREA','TO HIT','SAVE','HEX','ON FAILURE','ON SUCCESS','EFFECT','SLOSH','ELEMENTAL SLOSH','SEEPING SLOSH','PRISMATIC SURGE','CINDERSTEP','ICEFALL','THUNDERSTEP','ROOTWALK','WYRDFOLD','CINDER','CHILL','ARC','STATIC','OVERGROWTH','RENEWAL','DISRUPTION','FORMLESS','SECOND CAST','DAMAGE','TOXIN','IMPACT','LONG RANGE','PICK UP','AFTERBURN','PURIFY','EMPOWER','DURATION','OPEN DEFENCE','ARMOR MASTERY','DEFENSELESS','FORTIFIED','RAPID ATTACK','COOLDOWN','RESTRICTIONS','REQUIRES','EXAMPLE','KEYWORDS'] as const
