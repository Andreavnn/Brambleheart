...
<template>
  <header class="app-header-wrap">
    <div class="wip-banner" role="status">Brambleheart is a work in progress. Some features may be incomplete or produce errors.</div>
    <div class="app-header" :class="{ compact }">
      ...
      <div class="brand-stack">
        <RouterLink to="/characters" class="brand brand-logo-link" aria-label="Brambleheart Character List">
          <img src="/assets/Logo.png" alt="Brambleheart — Small Heroes, Big Adventures" class="brand-logo" />
          <small class="alpha-build">ALPHA BUILD {{ BUILD }}</small>
        </RouterLink>
