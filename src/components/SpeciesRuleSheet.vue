...
<template>
  <section class="species-rule-sheet">
    ...
    <details class="organized-rule-category species-rule-lore-placeholder card-surface"><summary><span><h2>{{ species.name }} Lore</h2><small>Expanded lore</small></span><span aria-hidden="true">⌄</span></summary><div class="organized-rule-category-body species-lore-placeholder-body" aria-label="Species lore placeholder"></div></details>
    <details class="organized-rule-category species-rule-trait-section card-surface">
      <summary><span><h2>Heritage Traits</h2><small>{{ species.speciesTraits.length }} traits</small></span><span aria-hidden="true">⌄</span></summary>
    ...
    <details class="organized-rule-category species-rule-trait-section card-surface">
      <summary><span><h2>Cultural Traits</h2><small>{{ species.cultureTraits.length }} traits</small></span><span aria-hidden="true">⌄</span></summary>
