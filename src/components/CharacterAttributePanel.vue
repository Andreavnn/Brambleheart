...
const groups=computed(()=>[
  {id:'agility',name:'Agility',short:'AGL',rank:props.attributes.agility,modifier:rankModifier(props.attributes.agility),secondary:[
    {name:'Accuracy',value:stats.value.accuracy,detail:'AGL Rank · ranged damage'},
    {name:'Aim',value:stats.value.aim,detail:'AGL modifier · ranged Strike'},
    {name:'Speed',value:stats.value.speed,detail:'2 + AGL modifier'},
  ]},
  {id:'might',name:'Might',short:'MIG',rank:props.attributes.might,modifier:rankModifier(props.attributes.might),secondary:[
    {name:'Fury',value:stats.value.fury,detail:'MIG Rank · melee damage'},
    {name:'Brawl',value:stats.value.brawl,detail:'MIG modifier · melee Strike'},
  ]},
  {id:'hide',name:'Hide',short:'HID',rank:props.attributes.hide,modifier:rankModifier(props.attributes.hide),secondary:[
    {name:'Guts',value:stats.value.guts,detail:props.gutsBonus?`HID Rank + ${props.gutsBonus} gear`:'HID Rank · damage reduction'},
    {name:'Ward',value:stats.value.ward,detail:'HID modifier · defense'},
  ]},
  {id:'lore',name:'Lore',short:'LOR',rank:props.attributes.lore,modifier:rankModifier(props.attributes.lore),secondary:[
    {name:'Power',value:stats.value.power,detail:'LOR Rank · magical damage'},
    {name:'Control',value:stats.value.control,detail:props.controlBonus?`LOR modifier + ${props.controlBonus} gear`:'LOR modifier · magical Strike'},
  ]},
  {id:'bravery',name:'Bravery',short:'BRY',rank:props.attributes.bravery,modifier:rankModifier(props.attributes.bravery),secondary:[
    {name:'Heart',value:stats.value.heart,detail:'BRY Rank · Magic Regen'},
    {name:'Spirit',value:stats.value.spirit,detail:'BRY modifier · Mana Pool'},
  ]},
])
</script>
