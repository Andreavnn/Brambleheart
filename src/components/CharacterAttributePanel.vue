...
<template>
  <div class="character-attribute-panel">
    <div class="character-attribute-stack">
      <article v-for="group in groups" :key="group.id" class="character-attribute-card" :class="`attribute-${group.id}`">
...
<style scoped>
.character-attribute-panel{display:grid;gap:9px}.character-attribute-stack{display:grid;gap:8px}.character-attribute-card{--attribute-tone:#9a6a28;display:grid;grid-template-columns:minmax(190px,.72fr) minmax(0,1.55fr);gap:10px;align-items:stretch;padding:10px;border:1px solid var(--surface-line,var(--line));border-radius:9px;background:var(--surface-front,var(--paper));box-shadow:0 2px 7px rgba(0,0,0,.04)}.character-attribute-card.attribute-agility{--attribute-tone:#46779a}.character-attribute-card.attribute-might{--attribute-tone:#9b543e}.character-attribute-card.attribute-hide{--attribute-tone:#527934}.character-attribute-card.attribute-lore{--attribute-tone:#6d5293}.character-attribute-card.attribute-bravery{--attribute-tone:#a06b2c}.character-attribute-card-heading{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:9px;align-items:center;padding-right:10px;border-right:1px solid var(--surface-line,var(--line))}.character-attribute-name strong{font-family:Georgia,'Times New Roman',serif;font-size:calc(19px + var(--font-offset));line-height:1.1}.character-attribute-name small{font:inherit;font-size:.66em;color:var(--ink-soft)}.character-attribute-core-values{display:grid;grid-template-columns:repeat(2,50px);gap:6px}.character-attribute-core-values>span{display:grid;justify-items:center;gap:2px;min-width:0;width:50px;padding:6px 3px;border:1px solid var(--line);border-left:4px solid var(--attribute-tone);border-radius:7px;background:var(--paper-2)}.character-attribute-core-values small{color:var(--ink-soft);font-size:calc(8px + var(--font-offset));font-weight:800}.character-attribute-core-values b{font-size:calc(14px + var(--font-offset))}.character-secondary-stat-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;align-content:stretch}.character-secondary-stat-grid.secondary-count-3{grid-template-columns:repeat(3,minmax(0,1fr))}.character-secondary-stat-card{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2px 7px;align-items:baseline;padding:8px 9px;border:1px solid var(--line);border-left:4px solid var(--attribute-tone);border-radius:7px;background:var(--paper-2)}.character-secondary-stat-card>span{font-weight:850}.character-secondary-stat-card>strong{font-size:calc(17px + var(--font-offset));color:var(--accent-dark)}.character-secondary-stat-card>small{grid-column:1/-1;color:var(--ink-soft);font-size:calc(8.5px + var(--font-offset));line-height:1.3}.character-magic-resource-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.character-magic-resource-grid article{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2px 8px;align-items:baseline;padding:10px 11px;border:1px solid var(--line);border-left:5px solid #766b5d;border-radius:9px;background:var(--paper-2)}.character-magic-resource-grid .mana-pool-resource{border-left-color:#6d5293}.character-magic-resource-grid .magic-regen-resource{border-left-color:#3d6fa3}.character-magic-resource-grid span{font-weight:850}.character-magic-resource-grid strong{font-size:calc(20px + var(--font-offset));color:var(--accent-dark)}.character-magic-resource-grid small{grid-column:1/-1;color:var(--ink-soft)}
