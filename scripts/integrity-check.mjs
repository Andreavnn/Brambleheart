...
// Beta 0.26 rules/presentation integrity.
...
assert.match(rules,/FATE ROLL:[\s\S]{0,300}\[6\] or higher[\s\S]{0,250}\[5\] or lower[\s\S]{0,250}Fate Mark/,'Fate Roll procedure must remain current')
...
assert.match(ruleReader,/Hallowing Thorns[\s\S]{0,300}Range \[5\][\s\S]{0,100}ORB\[4\]/,'Spell Range example must use Hallowing Thorns current range/area')
