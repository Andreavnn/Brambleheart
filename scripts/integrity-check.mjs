...
assert.deepEqual(changelogReleases,['0.05','0.04','0.03'],'Site Update history must retain the condensed three-release history')
...
assert.equal((gameUpdatesSource.match(/\n  \{\n    version:/g)||[]).length,1,'Game Update history must remain consolidated into v0.01 Launch Patch')
assert.match(gameUpdatesSource,/version:GAME_RULES_VERSION[\s\S]{0,100}title:'Launch Patch'/,'Consolidated Launch Patch must derive from the canonical v0.01 release marker')
